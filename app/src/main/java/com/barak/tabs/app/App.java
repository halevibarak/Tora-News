...
public class App extends Application {
    ...
    public static ArrayList<MyTab> getTabs() {
        ...
        if (json.equals("")) {
            ...
            start_.add(new MyTab("מכון מאיר", getInstance().getString(R.string.main_url), MyTab.TabType.MEIR, true));
            start_.add(new MyTab("מאיר מומלצים", getInstance().getString(R.string.main_like), MyTab.TabType.MEIR, false));
            start_.add(new MyTab("הר ברכה שמיעה", getInstance().getString(R.string.main_bra), MyTab.TabType.REST, true));
            start_.add(new MyTab("הר ברכה פיד", getInstance().getString(R.string.main_b), MyTab.TabType.REST, false));
            start_.add(new MyTab("שאלות ישיבה", getInstance().getString(R.string.main_ask), MyTab.TabType.REST, true));
            ...
            start_.add(new MyTab("הרב שרקי", getInstance().getString(R.string.harav_sharki), MyTab.TabType.MEIR, false));
            ...
            start_.add(new MyTab("פרשת השבוע", getInstance().getString(R.string.harav_parasha), MyTab.TabType.MEIR, false));
            ...
            start_.add(new MyTab("הרב אייל ורד", getInstance().getString(R.string.harav_eyal), MyTab.TabType.MEIR, false));
